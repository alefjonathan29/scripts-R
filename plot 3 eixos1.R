...
axis(2, ylim=c(0,max(pop)),col="black",lwd=1)
...
plot(time, med, axes=F, ylim=c(0,max(med)), xlab="", ylab="", 
     type="l", main="",xlim=c(7000,3400),lwd=1,col="red")
axis(4, ylim=c(0,max(med)),lwd=1,col="red")
points(time, med,pch=20,col="red")
mtext(4,text="Median Group Size",line=2,col="red")
...
plot(time, grp, axes=F, ylim=c(0,max(grp)), xlab="", ylab="", 
     type="l", main="",xlim=c(7000,3400),lwd=1,col="blue")#lty=3 linha tracejada
axis(2, ylim=c(0,max(grp)),lwd=1,line=3.5,col="blue")

points(time, grp,pch=20,col="blue")
mtext(2,text="Number of Groups",line=5.5,col="blue")
...
legend("topright",legend=c("Population","Median Group Size","Number of Groups"),lty=c(1),
